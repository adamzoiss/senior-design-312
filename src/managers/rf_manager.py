...
Team 312
File : rf_manager.py
Description: This will handle the connection to the CC1101 RF module. Any data being
...
class RFM69:
    ...
    def _write_u8(self, address: int, val: int) -> None:
        ...
        self._device.xfer2([address | 0x80, val & 0xFF])  # Write single byte
