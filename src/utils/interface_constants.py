...
# SW_4 = 12  # GPIO pin for push button 4 - pin 31
...
# GPIO BCM Pin numbers for the ANO rotarty encoder and push buttons
SW_1 = 24  # GPIO pin for push button 1 - pin 37
SW_2 = 17  # GPIO pin for push button 2 - pin 35
SW_3 = 13  # GPIO pin for push button 3 - pin 33
SW_4 = 12  # GPIO pin for push button 4 - pin 31
SW_5 = 22  # GPIO pin for push button 5 - pin 29

ENC_A = 5  # GPIO pin for rotary encoder A - pin 40
ENC_B = 27  # GPIO pin for rotary encoder B - pin 38
